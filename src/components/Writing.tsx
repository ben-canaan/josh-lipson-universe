                ...
                <div className="max-w-5xl mx-auto">
                        <div className="grid md:grid-cols-2 gap-16">
                            ...
                            <div className="flex items-center gap-2 text-muted-foreground">
                                              ...
                                              <span className="text-sm font-body">Loading posts...</span>span>
                            </div>div>
                                                            )}
                                                {error && (
                            ...
                            <a
                                              ...
                                              >
                                              <p className="text-xs text-muted-foreground font-body mb-1">{post.pubDate}</p>p>
                                              <p className="font-display text-lg text-foreground group-hover:text-primary transition-colors">{post.title}</p>p>
                                              <p className="text-sm text-muted-foreground font-body mt-2 line-clamp-2">{post.description}</p>p>
                            </a>a>
                          ))}
                                              </div>div>
                                  </div>div>
                                            ...
                                            <a
                                                              ...
                                                              <div className="flex items-start gap-4">
                                                                                  ...
                                                                                  <div className="flex-1">
                                                                                                        <p className="text-xs text-muted-foreground font-body mb-1">YouTube</p>p>
...
export default Writing;</section>
